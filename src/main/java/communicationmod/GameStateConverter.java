...
public class GameStateConverter {
    ...
    private static HashMap<String, Object> convertCardToJson(AbstractCard card) {
        ...
        jsonCard.put("raw_description", card.rawDescription);
        ...
        jsonCard.put("base_heal", card.baseHeal);
        jsonCard.put("base_draw", card.baseDraw);
        jsonCard.put("base_discard", card.baseDiscard);
